...
const AfterPaymentSucces = () => {
    return (
        <div>
            <Discount />
            <Header />
            <div className='h-[704px]'>
                <div className=" bg-[#D5E5D7] h-[160px]">
                    <div>
                        <p className='w-[204px] h-[29px] text-[24px] pt-[35px] font-bold text-[#0E1422] ml-[175px]'>Successful Order</p>
                        <div className="flex w-[228px] pt-11 ml-[175px]">
                            ...
                            <p className="w-[116px] h-[25px] text-[14px] font-semibold text-[#0E1422]">Successful Order</p>
                        </div>
                        <img className='w-[160.93px] h-[159.73px] ml-[640px] mt-[160px]' src="/images/aftsucces.svg" alt="succsses box" />
                        <h2 className='w-[278px] h-[29px] ml-[580px] mt-[20.27px] text-[24px] text-[#0E1422] font-bold'>Thank you for shopping</h2>
                        <p className='w-[379px] h-[50px] ml-[530px] mt-[16px] text-[14px] text-[#5C5F6A]'>Your order has been successfully placed and is now being processed.</p>
                        <div>
                            <div className="w-[196px] h-[44px] bg-[#0E1422] flex rounded-[4px] ml-[621px] mt-[48px]">
                                <button className="w-[118px] h-[25px] text-[#FFFFFF] text-[14px] mt-2 ml-6">Go to my account</button>
...
export default AfterPaymentSucces;