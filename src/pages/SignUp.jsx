        ...
        <div>
            ...
            <div>
                <div className=" bg-[#F6F6F6] h-[160px]">
                    <div>
                        <p className='w-[89px] h-[29px] text-[24px] pt-[35px] font-bold text-[#0E1422] ml-[175px]'>Sign up</p>
                        <div className="flex w-[159px] pt-11 ml-[175px]">
                            ...
                            <a className="w-[51px] h-[25px] text-[14px] font-semibold text-[#0E1422]" href='/SignUp'>Sign up</a>
                        </div>
                        ...
                        <p className='w-[318px] h-[52px] text-[12px] text-[Neutral/Black/B500] ml-[565px] '>By creating an account you agree with our Terms of Service, Privacy Policy,
                        </p>
                        <button className='w-[318px] h-[44px] bg-[#0E1422] text-white rounded-[4px] ml-[565px] mt-[24px]'>Create account
                        </button>
                        <p className='w-[215px] h-[25px] text-[14px] text-[#5C5F6A] ml-[617px] mt-[24px]'>Already have an account? Log in</p>
                    </div>
