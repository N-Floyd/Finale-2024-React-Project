      ...
      <div className="mt-[123px] mb-[148px]">
        ...
        <form onSubmit={onSubmitForm}>
          <div className="mt-[32px] transition hover:-translate-y-1 hover:scale-110 duration-500">
            ...
            <input onChange={onUserNameChange} className="border border-1 rounded-[6px] w-[320px] h-[45px]" type="text" autoComplete="username"/>
          </div>
  
          <div className="mt-[32px] transition hover:-translate-y-1 hover:scale-110 duration-500">
            <label className="block">Password</label>
            <input onChange={onPasswordChange} className="border border-1 rounded-[6px] w-[320px] h-[45px]" type="password" autoComplete="current-password" />
          </div>
          ...
          <button type='submit' className="w-[318px] h-[44px] bg-[#0E1422] text-white rounded-[4px] mt-[24px] transition hover:scale-110 hover:-translate-y-1 duration-500">
        ...
        <div className="flex justify-center mt-[24px] hover:scale-110 hover:-translate-y-1 duration-500">
          <Link to="/signup" className="text-[#5C5F6A]"> Don't have an account? Sign up</Link>
        </div>
      </div>
    </div>
  );
