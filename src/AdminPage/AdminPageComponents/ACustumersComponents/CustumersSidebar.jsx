...
const CustumersSidebar = () => {
  return (
    ...
    <div className='px-[24px]'>
      ...
      <div className='flex gap-[10px] rounded-[8px] px-[24px] py-[8px] mt-[16px]'>
        <img className='w-[24px] h-[24px]' src="/images/aside3.svg" alt="shopping trolley" />
        <a className='text-[#5C5F6A]' href='aorders'>Orders</a>
      </div>
      <div className='flex gap-[10px] bg-[#F6F6F6] rounded-[8px] px-[24px] py-[8px] mt-[16px]'>
        <img className='w-[24px] h-[24px]' src="/images/aside4d.svg" alt="account icon" />
        <a className='text-[#0E1422] font-semibold' href='acustumer'>Customers</a>
      </div>
      <div className='flex gap-[10px] rounded-[8px] px-[24px] py-[8px] mt-[16px]'>
...
export default CustumersSidebar;