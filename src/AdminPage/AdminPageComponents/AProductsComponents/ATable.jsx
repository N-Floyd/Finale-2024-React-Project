  ...
  return (
    ...
    <thead className='border-t border-b'>
        <tr className="text-[#5C5F6A] ">
            <img className='p-2' src="/images/a1sort.svg" alt="" />
    ...
    <tbody className="text-[14px]">
        <tr className="border-b hover:bg-gray-100">
            <img className='w-[48px] h-[48px] p-2' src="/images/a1.png" alt="" />
            ...
            <img className='py-3 px-6' src="/images/adots.svg" alt="" />
        </tr>
        <tr className="border-b hover:bg-gray-100">
            <img className='w-[48px] h-[48px] p-2' src="/images/a2.png" alt="" />
        ...
        <tr className="border-b hover:bg-gray-100">
            <img className='w-[48px] h-[48px] p-2' src="/images/a3 .png" alt="" />
        ...
        <tr className="border-b hover:bg-gray-100">
            <img className='w-[48px] h-[48px] p-2' src="/images/a4.png" alt="" />
        ...
        <tr className="border-b hover:bg-gray-100">
            <img className='w-[48px] h-[48px] p-2' src="/images/a5.png" alt="" />
        ...
        <tr className="border-b hover:bg-gray-100">
            <img className='w-[48px] h-[48px] p-2' src="/images/a6.png" alt="" />
        ...
        <tr className="border-b hover:bg-gray-100">
            <img className='w-[48px] h-[48px] p-2' src="/images/a7.png" alt="" />
        ...
        <tr className="border-b hover:bg-gray-100">
            <img className='w-[48px] h-[48px] p-2' src="/images/a8.png" alt="" />
